      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 max-w-4-xl mx-auto">
          {societies.length > 0 ? (
            ...
            <div className="bg-gray-50/60 p-8 rounded-2xl border border-gray-100 text-center text-neutral-gray font-medium">
              No societies listed on the leaderboard yet.
            </div>
          )}
        </div>
